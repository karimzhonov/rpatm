...
//                context.commit('basic', {key: 'files', value: files})
        ...
        async fetch_sector_region_bar_chart_data(context, params) {
            const bar = await axios.get('/api/ichd/sector-region-bar-chart/', {params})
            context.commit('basic', {key: 'sector_region_bar_chart_data', value: bar.data})
            return bar.data
        },
        async fetch_region_data_table(context, params) {
            const table = await axios.get('/api/ichd/region-data/', {params})
            context.commit('basic', {key: 'region_data_table', value: table.data})
            return table.data
        }
    },
